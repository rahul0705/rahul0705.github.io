...
Browser tests and Lighthouse consume that validated artifact in parallel. Deployment directly requires every check to succeed before a push to `main` can deploy the same output to GitHub Pages.
